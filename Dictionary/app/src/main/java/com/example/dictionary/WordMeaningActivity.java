...
import com.example.dictionary.fragements.FragmentAntonyms;
import com.example.dictionary.fragements.FragmentDefinition;
import com.example.dictionary.fragements.FragmentExample;
import com.example.dictionary.fragements.FragmentSynonyms;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enWord = bundle.getString("en_words");
        ...
        if(c.moveToFirst()){
            ...
            amtonyms = c.getString(c.getColumnIndex("antonyms"));
        }
                ...
                tts = new TextToSpeech(WordMeaningActivity.this, new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if(status == TextToSpeech.SUCCESS)
                        {
                            ...
                            Log.e("error", "Initializetion Failed");
                        }
                    }
                });
            }
        ...
        androidx.appcompat.widget.Toolbar toolbar = findViewById(R.id.mToolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(enWord);
        toolbar.setNavigationIcon(R.drawable.arrow);
        viewPaper = (ViewPager)findViewById(R.id.tab_viewpaper);
        if (viewPaper != null)
        {
            setupViewPage(viewPaper);
        }
    ...
    private static class ViewPaperAdapter extends FragmentPagerAdapter{
        private final List<Fragment> mFragmentList=new ArrayList<>();
        private final List<String> mFragmentTitleList = new ArrayList<>();
        ViewPaperAdapter(FragmentManager manager){
            super(manager);
        }
